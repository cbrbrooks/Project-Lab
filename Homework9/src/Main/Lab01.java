...
public class Lab01{
	public static void main(String[] args){
		...
		int[] c = new int[0];	// This is an 	 array for testing
		...
		int max = lab.getMax();				// Retrieve tester max value (should be 9)
		if(max != 9){
			points -= 5;
			Feedback += "Inaccurate 'getMax' result. Should be 9 (-5 pts);";
		}
		int sum = lab.getSum();				// Retrieve tester sum value (should be 45)
		if(sum != 45){
			points -= 5;
